...
export default (store) => ({
  ...
  getComponent(nextState, cb) {
    ...
    require.ensure([], (require) => {
      injectReducer(store, {key: REDUCER_KEYS.VEHICLE_REPORT_DATA, reducer: require("./reducers/VehicleReport.reducer").default});
      injectReducer(store, {key: REDUCER_KEYS.VEHICLES, reducer: require("./../../../Vehicles/reducers/Vehicles.reducer.js").default});
      cb(null, require("./containers/VehicleReport.container.js").default);
      NProgress.done();
    })
  },
