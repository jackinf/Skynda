...
class Reviews extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        {reviews && !_.isEmpty(reviews)
          ?
          <div className="reviews">
            <Skblock header={<Translate value="details.components.reviews.header"/>}>
                ...
                return ((<div key={i} className='panel panel-default'>
                    <div className='panel-body'>
                      ...
                      {review.videoUrl ? (<Row className='sk_details__reviews__body'>
                        <Col md={12}>
                          <iframe width="520" height="315" src={review.videoUrl.replace("watch?v=", "embed/")}
              ...
              <Dialog
                title={(<div>
                  ...
                  <img className='sk_details__report__question-close-button' onClick={this.closeModal}
                       src={imagesClose}/>
                </div>)}
                actions={[]}
                modal={false}
