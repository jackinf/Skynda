...
public class VehicleManufacturerControllerServiceImplTest {
    ...
    public void get() throws Exception {
        ...
        VehicleManufacturerResponseDto vehicleModelResponseDto = response.get(0);
        ...
        assertEquals("description123", vehicleModelResponseDto.getDescription());
    }
