...
namespace Triven.API.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        // GET api/account/manage-info?returnUrl=%2F&generateState=true
        [Route("manage-info")]
        ...
        // POST api/account/add-external-login
        ...
        // GET api/account/external-logins?returnUrl=%2F&generateState=true
        [AllowAnonymous]
        ...
        [AllowAnonymous]
        [Route("register")]
        public IHttpActionResult Register([FromBody] AccountRegisterViewModel viewModel)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        [HttpGet, Route("account-info"), ResponseType(typeof(AccountDisplayViewModel))]
        public IHttpActionResult GetAccountInfo()
        {
            ...
            var service = new AccountService(Request.GetOwinContext().GetUserManager<ApplicationUserManager>());
            var result = service.GetAccountData(User.Identity.GetUserId<int>());
            return result.IsSuccessful ? Ok(result) : (IHttpActionResult)NotFound();
        }

        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        [HttpPost, Route("change-general-data"), ResponseType(typeof(AccountDisplayViewModel))]
        public IHttpActionResult EdidGeneralAccountData(AccountDisplayViewModel viewModel)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
        ...
        [HostAuthentication(DefaultAuthenticationTypes.ExternalBearer)]
        [HttpGet, Route("users"), ResponseType(typeof(List<AccountDisplayViewModel>))]
