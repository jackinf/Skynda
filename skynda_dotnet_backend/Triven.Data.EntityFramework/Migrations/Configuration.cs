        ...
        private static void CreateClassificationTypes(ApplicationDbContext context, ApplicationUser admin)
        {
            ...
            var classificationTypeManufacturer = new ClassificationType
            {
                ...
                Classifications = new List<Classification>
                {
                    ...
                    Factory.CreateClassification("ŠSkoda", "SKODA", admin, weight: 560),
                    Factory.CreateClassification("ŠSmart", "SMART", admin, weight: 570),
                    Factory.CreateClassification("ŠSpyker", "SPYKER", admin, weight: 580),
                    Factory.CreateClassification("ŠSubaru", "SUBARU", admin, weight: 590),
                    Factory.CreateClassification("ŠSuzuki", "SUZUKI", admin, weight: 600),
                    Factory.CreateClassification("ŠTesla", "TESLA", admin, weight: 610),
